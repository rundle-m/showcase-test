        ...
        <div className="relative z-10">
                   ...
                   <div className="bg-white dark:bg-stone-800 p-4 rounded-xl shadow-sm space-y-4">
                      ...
                      <div className="border-t border-stone-100 dark:border-stone-700 pt-4">
                        ...
                        <div className="flex gap-2">
                            <input type="text" placeholder="Paste image URL..." className="flex-1 p-2 bg-stone-50 dark:bg-stone-700 dark:text-white rounded outline-none text-xs border border-transparent focus:border-purple-500" value={formPrefs.bannerUrl || ''} onChange={(e) => setFormPrefs({...formPrefs, bannerUrl: e.target.value})} />
                      ...
                      <div className="border-t border-stone-100 dark:border-stone-700 pt-4">
                        ...
                        <div className="flex gap-2">
                            <input type="text" placeholder="Paste image URL..." className="flex-1 p-2 bg-stone-50 dark:bg-stone-700 dark:text-white rounded outline-none text-xs border border-transparent focus:border-purple-500" value={formPrefs.backgroundUrl || ''} onChange={(e) => setFormPrefs({...formPrefs, backgroundUrl: e.target.value})} />
            ...
            <div className="mx-4 -mt-20 mb-8 relative z-10">
              <div className={`bg-white/80 dark:bg-stone-900/80 backdrop-blur-xl border p-6 rounded-3xl shadow-xl flex flex-col items-center text-center transition-colors ${currentTheme.border}`}>
                  <div className={`w-24 h-24 -mt-16 rounded-2xl bg-white dark:bg-stone-800 p-1 shadow-lg rotate-3 mb-3 ring-4 ${currentTheme.ring}`}>
              ...
              <section className="px-6">
                ...
                <div className="space-y-4">
                  {profile?.projects?.map((project, i) => (
                    <div key={i} onClick={() => openProject(project.url)} className={`bg-white dark:bg-stone-900 p-4 rounded-2xl shadow-sm border border-stone-100 dark:border-stone-800 flex items-center gap-4 active:scale-95 transition cursor-pointer hover:border-transparent hover:ring-2 ${currentTheme.ring.replace('ring-', 'hover:ring-')}`}>
